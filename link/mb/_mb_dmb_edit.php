            ...
            <div class="card">
              ...
              <div class="card-body">                
                <div class="row">
                    ...
                    <form method="post" action="link/crud.php?process=update_dmb" enctype="multipart/form-data">
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <input type="hidden" name="id_mutasi" value="<?=$id_mutasi; ?>" >
                                    <button type="submit" name="update_dmb" class="btn btn-primary">Simpan</button>
