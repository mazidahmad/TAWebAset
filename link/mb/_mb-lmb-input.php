          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">                
                <div class="row">
                    <div class="col-md-12">
                    <form method="post" action="link/crud.php?process=insert_lmb" enctype="multipart/form-data">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 align-middle">
                                    <button type="submit" name="insert_lmb" class="btn btn-primary">Simpan</button>
