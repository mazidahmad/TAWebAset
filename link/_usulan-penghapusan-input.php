                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form method="post" action="link/crud.php?process=insert_usulan" enctype="multipart/form-data">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput" name="CARA_PEROLEHAN">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 align-middle">
                                        <button type="submit" name="insert_usulan" class="btn btn-primary">Simpan</button>
                                        <button value="kembali" class="btn btn-secondary"><a href="../index.php?page=usulan-penghapusan.php"></a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
