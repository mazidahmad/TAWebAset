                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form method="post" action="link/crud.php?process=update_bmd"
                                enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="formGroupExampleInput">NO_KODE_LOKASI_BARANG :</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput"
                                            name="NO_KODE_LOKASI_BARANG">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" cDOKUMEN_BARANGlass="form-control" id="formGroupExampleInput"
                                            name="DOKUMEN_BARANG">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6 align-middle">
                                        <button type="submit" name="update_bmd"
                                            class="btn btn-primary">Update</button>
                                        <button value="kembali" class="btn btn-secondary"><a
                                                href="bmd-gunausaha.php">Back</a></button>
                                    </div>
                                </div>
                            </form>
                        </div>
