      ...
      <div class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="class col-md-4"><p class="card-title text-center"><strong>DAFTAR BARANG MILIK DAERAH YANG DIGUNAUSAHAKAN</strong></p></div>
                    <div class="class col-md-4"><button type="button" class="btn btn-outline-primary ml-2 float-right"> <a href="index.php?page=bmd-gunausaha-input">Input Data</a> </button></div>
                  </div>
                </div>
                <div class="card-body" style="font-size:8pt;">
                  ...
                  <div class="table table-responsive">
                    <table id="table_gunausaha" class="display">
        ...
        <script>
              $(document).ready(function() {
                var table = $('#table_gunausaha').removeAttr('width').DataTable({
                  dom: 'Bfrtip',
                  buttons: [ 
                    {
                      extend: 'pdfHtml5',
